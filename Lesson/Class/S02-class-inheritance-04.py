...
class CalcProto():
    ...
    def printtotal(self):
        print("[CalcProto] __init__ : total=", self.total)
        return self.total
#%%
# 더하기 계산기
...
class Calc(CalcPlus, CalcMinus):
    ...
    def printtotal(self):     # override(재정의)
        super().printtotal()  # 부모의 매서드 호출
        print("[Calc] printtotal : total=", self.total)
